...
/**
 *
 * Maintains the Redis cache tracking token staking balances per participant ("actor")
 * Removes 0 balances and prevents negative values
 */
    ...
    try {
      ...
      for (let event of events) {
        ...
        if (eventName === "Staked") {
          ...
          actorBalance -= amount;
          if (actorBalance < 0) actorBalance = 0;
        }
